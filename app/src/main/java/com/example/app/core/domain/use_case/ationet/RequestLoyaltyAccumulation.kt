...
class RequestLoyaltyAccumulation(
    ...
    companion object {
        val logger = Logger("RequestLoyaltyAccumulationUseCase")
    }
    ...
    suspend operator fun invoke(
        ...
        try {
            ...
            val nativeResponse = unitCode?.let {
                nativeInterface.requestLoyaltyAccumulation(
    ...
    suspend operator fun invoke(
        ...
        try {
            ...
            val nativeResponse = nativeInterface.requestLoyaltyAccumulation(
                terminalId = configuration.ationet.terminalId,
                systemModel = deviceInfo.model,
                systemVersion = BuildConfig.VERSION_NAME,
                transactionSequenceNumber = tsn,
