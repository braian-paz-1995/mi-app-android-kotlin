...
fun SummaryContent(
    ...
    val formattedDate = remember(summaryData.date) {
        LocaleFormatter.formatDateTime(dateTime = summaryData.date, context = context)
    }

    val data = mapOf(
        stringResource(R.string.label_date) to formattedDate,
    ...
    AATScaffold(
        ...
        com.ationet.androidterminal.core.presentation.SummaryScreen(
            ...
            title = stringResource(R.string.clear_summary),
            data = data,
            buttons = {
                Column(
                    modifier = Modifier
