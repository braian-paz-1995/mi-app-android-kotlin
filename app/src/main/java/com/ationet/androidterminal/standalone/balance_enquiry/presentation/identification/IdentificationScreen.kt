package com.ationet.androidterminal.standalone.balance_enquiry.presentation.identification
...
fun IdentificationScreen(
    ...
    when (val state = viewModel.state.collectAsStateWithLifecycle().value) {
        ...
        is IdentificationEntryState.IdentifierPresented -> {
            navController.navigateAndPopUp(BalanceEnquiryDestination.ProductSelection)
        }
    }
}