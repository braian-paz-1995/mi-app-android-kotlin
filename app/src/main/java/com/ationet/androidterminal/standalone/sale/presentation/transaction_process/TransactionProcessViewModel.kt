...
import com.ationet.androidterminal.standalone.sale.domain.use_case.SendSale
import com.ationet.androidterminal.standalone.sale.domain.use_case.TransactionResult
...
class TransactionProcessViewModel @Inject constructor(
    private val sendSaleUseCase: SendSale,
    ...
    private suspend fun sendSale() {
        when (val result = sendSaleUseCase()) {
            ...
            is TransactionResult.Success -> {
                ...
                operationStateRepository.updateState {
                    it.copy(authorizationCode = result.authorizationCode)
                }
            }
        }
    }
