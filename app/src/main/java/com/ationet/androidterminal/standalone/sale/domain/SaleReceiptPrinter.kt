package com.ationet.androidterminal.standalone.sale.domain
...
class SaleReceiptPrinter @Inject constructor(
        ...
        with(receipt.transactionData) {
            if (responseCode == ResponseCodes.AUTHORIZED) {
                ...
                printProducts(
                    product = product,
                    configuration = receipt.printConfiguration,
                    transactionAmount = receipt.transactionData.transactionAmount
                )
            } else {
