package com.ationet.androidterminal.standalone.sale.presentation.product_selection
    ...
    AATScaffold(
        ...
        if (products.isEmpty()) {
            InfoScreenTemplate(
                ...
                extraContent = {
                    AATInfoCard(
                        text = stringResource(R.string.select_fuel_info_card)
                    )
                }
            )
        } else {
    ...
    Surface(modifier = modifier) {
        Box(modifier = Modifier.padding(horizontal = 16.dp)) {
            Column(
                ...
                AATHeaderTitle(stringResource(R.string.select_fuel))
