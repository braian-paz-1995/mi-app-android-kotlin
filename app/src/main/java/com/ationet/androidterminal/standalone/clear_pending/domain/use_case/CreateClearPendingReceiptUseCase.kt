...
@Singleton
class CreateClearPendingReceiptUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        val receipt = createReceipt(
            ...
            receiptData = try {
                ...
                Log.w(TAG, "Clear Pending receipt: Failed to decode receipt data", e)
                ReceiptData()
            },
        ...
        Log.i(TAG, "Clear Pending receipt: Created receipt #$receiptId")
        return receipt.copy(id = receiptId)
    }

    private companion object {
        private const val TAG: String = "ClearPendingReceipt"
    }
}