...
class GetTransactionsRedemptionPointsWithLoyaltyBatchIdUseCase @Inject constructor(
    ...
    suspend operator fun invoke(batchId: Long, controllerType: Configuration.ControllerType): List<LoyaltyBatchTransaction> {
        ...
        val result = batchRepository.getTransactionsRedemptionPointsWithLoyaltyBatchId(batchId, controllerType.toString())
