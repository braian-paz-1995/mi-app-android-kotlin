...
@Singleton
class RequestLoyaltyVoidTransaction @Inject constructor(
    ...
    companion object {
        val logger = Logger("RequestLoyaltyVoidTransaction")
    }
    ...
    suspend operator fun invoke(
        ...
        try {
            ...
            val nativeResponse = nativeInterface.requestLoyaltyVoidTransaction(
            ...
            logger.error("Error requesting Loyalty void transaction", e)
